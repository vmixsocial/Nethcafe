                ...
                ?>
                  <tr>
                      ...
                      <td><ul><?php 
                        ...
                        ?></ul></td>
                        <td>
                        Bill Created &nbsp;<a href="<?php echo base_url()?>index.php/dashboard/bill_print/<?php echo $pend_order['order_id'];?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> View</a>
                        </td>
                  </tr>

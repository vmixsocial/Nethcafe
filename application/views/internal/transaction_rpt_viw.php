          ...
          <table class="table table-bordered table-striped" id="example1">
              ...
              <tbody>
                ...
                if($transdata){
                  ...
                  $inkm = 0;
                  $exp = 0;
                  foreach($transdata as $trndata){
                  if($trndata['incomes']!=""){ 
                    $inkm=$trndata['incomes']; 
                  }else{ 
                    $inkm=0; 
                  }
                ...
                ?>
                  <tr>
                      <td><?php echo $i;?></td>
                      <td><?php echo $trndata['curdate'];?></td>
                      <td><?php echo $inkm;?></td>
                      <td><?php echo $exp;?></td>
                      <td><?php echo $inkm-$exp;?></td>
                  </tr>
              ...
              <tfoot>
                <tr>
                      ...
                      <td><strong><?php echo $expence;?></strong></td>
                      <td>
